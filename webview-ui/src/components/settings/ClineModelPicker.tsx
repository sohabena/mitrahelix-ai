		...
		<div style={{ width: "100%", paddingBottom: 2 }}>
			...
			{hasInfo ? (
				...
				<p
					...
					The extension automatically fetches the latest MitraHelix model list. If you're unsure which model to choose,
					MitraHelix works best with <strong>anthropic/claude-sonnet-4.5</strong>.
				</p>
			)}
		</div>
	)
